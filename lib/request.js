...
const ProxyAgent = tryRequire('proxy-agent');
...
class RequestOptions {
  ...
  constructor(options, buffer) {
    ...
    this.proxy = process.env.socks_proxy || process.env.all_proxy;
  ...
  getProxyAgent() {
    if (typeof ProxyAgent !== undefined)
  ...
  toHTTP() {
    ...
    return {
      ...
      agent: this.pool ? null : this.proxy ? this.getProxyAgent() : false,
